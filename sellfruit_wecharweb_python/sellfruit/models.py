...
class Order(models.Model):
    ...
    allmoney = models.IntegerField(null=True) #总金额
...
class Price(models.Model):
    fruitType = models.PositiveSmallIntegerField(primary_key=True) #说过类型:1-苹果，2-香蕉，3-雪梨，4-柠檬
    price = models.IntegerField() #水果单价
...
class Comment(models.Model):
    # user = models.FreignKey(User) #用户
    # order = models.FreignKey(Order) #订单
    fruitType = models.PositiveSmallIntegerField() #水果类型:1-苹果，2-香蕉，3-雪梨，4-柠檬
    commment = models.TextField() #评论
    # class Meta:
